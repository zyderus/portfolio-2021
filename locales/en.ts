...
export default {
  ...
  aboutMe: 'About Me',
  aboutMeTextP1:
    'Hey! I am Rustam and I enjoy creating apps that put smiles on faces. My interest in application development started back in 1998. Then, as a student, I understood HTML and CGI scripts, by making me a personal web page with a guestbook. However, for the next someteen years, my career path did not steer towards the code in any way. From business consulting to artist management, construction recruiting, logistics. Then, in 2018, Arduino fell into my hands. And the rest is history.',
  aboutMeTextP2:
    'Today in development I use the following set of tools that make it easier to create attractive, convenient and conversion-oriented applications:',
